...
import 'package:first_test_api/client.dart' as api;
...
class MockFirstTestApiClient extends Mock
    implements api.FirstTestApiClient {}
...
void main() {
  group('UserRepository', () {
    ...
    late MockFirstTestApiClient apiClient;
    ...
    setUp(() {
      ...
      apiClient = MockFirstTestApiClient();
