...
void main() {
  ...
  group('FirstTestApiClient', () {
    late http.Client httpClient;
    late FirstTestApiClient apiClient;
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = FirstTestApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => FirstTestApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = FirstTestApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws FirstTestApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<FirstTestApiMalformedResponse>()),
        );
      });

      test(
          'throws FirstTestApiRequestFailure '
        ...
        expect(
          () => apiClient.getArticle(id: articleId),
          throwsA(
            isA<FirstTestApiRequestFailure>()
