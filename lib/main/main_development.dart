...
import 'package:first_test/main/bootstrap/bootstrap.dart';
import 'package:first_test/src/version.dart';
  ...
  bootstrap(
    (
      ...
      final packageInfoClient = PackageInfoClient(
        appName: 'firstTest [DEV]',
        packageName: 'com.test.firstTest.dev',
